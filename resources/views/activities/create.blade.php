<x-app-layout>
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-white">Tambah Aktivitas Baru</h2>
                <p class="mt-1 text-gray-400">Isi detail aktivitas yang ingin Anda tambahkan</p>
            </div>

            <div class="bg-black border border-gray-800 rounded-xl overflow-hidden shadow-xl shadow-indigo-500/10">
                <form action="{{ route('activities.store') }}" method="POST" class="relative">
                    @csrf
